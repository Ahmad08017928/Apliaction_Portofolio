    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                <h2 class="font-bold text-4xl text-white mb-5">Code Craft</h2>
            ...
            <div class="w-full px-4 mb-12 md:w-1/3">
                <h3 class="font-semibold text-xl text-white mb-5">Navigasi</h3>
                <ul class="text-slate-300">
                    <li>
        ...
        <div class="w-full pt-10 border-t border-slate-700">
            ...
            <p class="font-medium text-xs  text-slate-500 text-center">Created by <a href="" target="_black" class="font-bold text-primary">ilham adi purnomo</a></p>
        </div>
    </div>
</footer>